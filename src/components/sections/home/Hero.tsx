...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Landing Builder',
  title: 'Build stunning landing pages in',
  titleHighlight: 'minutes, not hours',
  description:
    "QuickLanding's intelligent builder creates high-converting pages with zero coding. Perfect for startups, marketers, and agencies who need results fast.",
  features: [
  ...
  imageAlt: 'QuickLanding dashboard interface',
  statsLabel1: 'Conversion Rate',
  statsValue1: '+127% avg',
  statsLabel2: 'Build Time',
  statsValue2: '< 5 minutes',
} as const;
