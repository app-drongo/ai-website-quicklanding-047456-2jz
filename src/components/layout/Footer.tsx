...
export default function Footer({
  logoText = 'QuickLanding',
  companyDescription = 'Create stunning landing pages in minutes with our drag-and-drop builder. Trusted by over 10,000 businesses to convert visitors into customers with high-performing landing pages.',
  contactEmail = 'hello@quicklanding.com',
  contactPhone = '+1 (555) 123-4567',
  contactAddress = '123 Innovation Drive, San Francisco, CA 94107',
  newsletterTitle = 'Get Landing Page Tips',
  newsletterDisclaimer = 'Weekly tips on conversion optimization and landing page best practices. Unsubscribe anytime.',
  section1Title = 'Platform',
  section2Title = 'Company',
  section3Title = 'Resources',
  section4Title = 'Legal',
  copyrightText = '© 2024 QuickLanding. All rights reserved.',
  madeWithText = 'by the QuickLanding team',
  socialText = 'Follow us:',
  social1Href = 'https://twitter.com/quicklanding',
  social2Href = 'https://facebook.com/quicklanding',
  social3Href = 'https://instagram.com/quicklanding',
  social4Href = 'https://linkedin.com/company/quicklanding',
  social5Href = 'https://github.com/quicklanding',
}: FooterProps) {
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Drag & Drop Builder', href: '/builder' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Conversion Guide', href: '/conversion-guide' },
        { name: 'Design Resources', href: '/design-resources' },
